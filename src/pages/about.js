...
const About = () => (
  <div className="static-page">
    <h1>About</h1>
    <div className="body">
      <p>My name is Nicholas Jackson. I'm a full time software developer and project manager for Cypress Semiconductor. There, I do mostly project management and Java development.</p>
